...
,
		"rect" : [ 253.0, 101.0, 1010.0, 569.0 ],
		"bgcolor" : [ 0.715001, 0.888382, 1.0, 0.9 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 349.0, 37.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 333.0, 28.0, 53.0, 20.0 ],
					"text" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1099.76001, 218.0, 150.0, 34.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "#1", "#2", "#3", "#4", "#5", "texture1", "gradientEditor" ],
					"id" : "obj-48",
					"maxclass" : "bpatcher",
					"name" : "drager.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 1068.0, 134.0, 320.0, 74.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 14.0, 296.5, 68.0, 20.0 ],
					"text" : "r degdump"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 748.5, 169.0, 138.0, 18.0 ],
					"restore" : [ 100.0, 0.0, 1.0, 0.0, 0.5, 0, 100.0, 0.5, 0, "linear" ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "pattr #1-cb @autorestore 0",
					"varname" : "#1-cb"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 748.5, 203.0, 138.0, 18.0 ],
					"restore" : [ 100.0, 0.0, 1.0, 0.0, 0.5, 0, 100.0, 0.5, 0, "linear" ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "pattr #1-cg @autorestore 0",
					"varname" : "#1-cg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 18.5, 11.0, 138.0, 18.0 ],
					"restore" : [ 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "pattr #1-cn @autorestore 0",
					"varname" : "#1-cn"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 748.5, 236.0, 135.0, 18.0 ],
					"restore" : [ 1 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "pattr #1-ct @autorestore 0",
					"varname" : "#1-ct"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 656.0, 348.0, 135.0, 18.0 ],
					"restore" : [ 100.0, 0.0, 1.0, 0.0, 0.5, 0, 100.0, 0.5, 0, "linear" ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "pattr #1-cr @autorestore 0",
					"varname" : "#1-cr"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 608.0, 380.0, 137.0, 18.0 ],
					"restore" : [ 100.0, 0.0, 1.0, 0.0, 1.0, 0, 46.81934, 0.588889, 0, 58.015266, 0.561111, 0, 68.702293, 0.511111, 0, 78.371498, 0.438889, 0, 87.277351, 0.311111, 0, 100.0, 0.0, 0, "linear" ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "pattr #1-ca @autorestore 0",
					"varname" : "#1-ca"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 821.0, 36.0, 92.0, 18.0 ],
					"text" : "presentation 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 821.0, 80.0, 69.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 821.0, 6.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 49.0, 468.0, 131.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 291.0, 404.0, 150.0, 34.0 ],
					"text" : "depth_enable 0\nblend_enable 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 49.0, 409.0, 229.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 258.0, 316.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 608.0, 291.0, 32.5, 20.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 9.0, 30.0, 27.0, 18.0 ],
					"text" : "size"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 101.0, 30.0, 27.0, 18.0 ],
					"text" : "type"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 37.0, 30.0, 59.0, 18.0 ],
					"varname" : "resolution"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 386.0, 28.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 194.0, 30.0, 27.0, 18.0 ],
					"text" : "edit"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 220.0, 30.0, 59.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 130.0, 30.0, 59.0, 18.0 ],
					"varname" : "type"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 14.0, 323.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 333.0, 258.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 49.0, 380.0, 125.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 51.0, 405.0, 205.0 ],
					"varname" : "gammaBlue"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 92.0, 323.0, 57.0, 18.0 ],
					"text" : "dim $1 1"
				}
